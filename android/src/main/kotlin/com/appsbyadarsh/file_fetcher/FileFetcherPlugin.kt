...
class FileFetcherPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "com.appsbyadarsh.filefetcher/fetchfile")
  ...
  override fun onMethodCall(call: MethodCall, result: Result) {
    ...
    if (call.method == "getPlatformVersion") {
      ...
      if (imageList.isNotEmpty()) {
        ...
        result.error("UNAVAILABLE", "No images available.", null)
      }
      ...
      if (videoList.isNotEmpty()) {
        ...
        result.error("UNAVAILABLE", "No videos available", null)
      }
      ...
      if (audioList.isNotEmpty()) {
        ...
        result.error("UNAVAILABLE", "No audio available", null)
      }
    }
...
data class CustomFile(var id: Long, var name: String, var path: String,var mimeType:String,var dateAdded:Int,var size:Int)
